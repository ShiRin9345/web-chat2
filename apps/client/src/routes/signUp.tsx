      ...
      <div className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-lg border border-border/50">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-foreground">注册账户</h1>
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <div className="flex flex-col items-center space-y-4">
                  <div
                    className="w-24 h-24 rounded-full border-2 border-dashed border-border bg-muted hover:border-primary transition-colors cursor-pointer overflow-hidden relative"
                  ...
                  {selectedFileRef.current && (
                    <div className="text-sm text-primary">✓ 已选择头像 </div>
                  )}
                </div>

                <FieldDescription>
                  点击上方圆形区域选择头像图片，支持 JPG、PNG 格式，大小不超过
                  5MB
                </FieldDescription>
              </Field>
            </FieldGroup>
